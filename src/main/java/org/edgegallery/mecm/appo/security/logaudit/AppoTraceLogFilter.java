...
package org.edgegallery.mecm.appo.security.logaudit;
...
public class AppoTraceLogFilter extends OncePerRequestFilter implements Ordered {
    ...
    private static final Logger loger = LoggerFactory.getLogger(AppoTraceLogFilter.class);
    ...
    private void logForRequest(String accessId, HttpServletRequest request) {
        ...
        loger.info("Http request trace log: {}", dump);
    }
    ...
    private void logForResponse(String accessId, HttpServletResponse response) {
        ...
        loger.info("Http response trace log: {}", dump);
    }
