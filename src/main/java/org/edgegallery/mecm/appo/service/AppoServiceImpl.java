...
import static org.edgegallery.mecm.appo.common.Constants.APPD_ID;
import static org.edgegallery.mecm.appo.common.Constants.APP_DESCR;
import static org.edgegallery.mecm.appo.common.Constants.APP_INSTANCE_ID;
import static org.edgegallery.mecm.appo.common.Constants.APP_INSTANCE_NOT_FOUND;
import static org.edgegallery.mecm.appo.common.Constants.APP_NAME;
import static org.edgegallery.mecm.appo.common.Constants.APP_PACKAGE_ID;
import static org.edgegallery.mecm.appo.common.Constants.MEC_HOST;
import static org.edgegallery.mecm.appo.common.Constants.OPER_STATUS_INVALID_STATE;
...
public class AppoServiceImpl implements AppoService {
    ...
    public ResponseEntity<Map<String, String>> createAppInstance(String accessToken, String tenantId,
        ...
        requestBodyParam.put(APP_DESCR, createParam.getAppInstanceDescription());
    ...
    public ResponseEntity<String> instantiateAppInstance(String accessToken, String tenantId, String appInstanceId) {
        ...
        try {
            ...
            logger.debug("Failed to get app instance info record for the ID: {}", appInstanceId);
        }
        if (appInstanceInfo == null) {
            return new ResponseEntity<>(APP_INSTANCE_NOT_FOUND, HttpStatus.BAD_REQUEST);
        }
        if (!appInstanceInfo.getOperationalStatus().equals("Created")) {
            return new ResponseEntity<>(OPER_STATUS_INVALID_STATE, HttpStatus.BAD_REQUEST);
        }
